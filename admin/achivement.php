...
<?php include 'left-menu.php'?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Achivements</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
 ...
 <div class="row">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style="width: 1244px;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 199.4px;" aria-sort="ascending" aria-label="srno: activate to sort column descending">Achivement Image</th>
                                        ...
                                        <?php
                                            ...
                                            try{
                                              $stmt = $conn->prepare("SELECT * FROM tbl_achivement  Order By creation_on DESC");
                                              $cnt=1;
                                              $stmt->execute();
                                              foreach($stmt as $row){
            ...
            <?php include 'achivement-popup.php'?>
