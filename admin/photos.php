                                    ...
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style="width: 1244px;">
                                        ...
                                        <?php
                                            ...
                                            try{
                                              ...
                                              $stmt->execute();
                                              foreach($stmt as $row){
                                                $image = (!empty($row['image'])) ? 'assets/images/photos/'.$row['image'] : 'assets/images/users/profile.jpg';
                                        ...
                                        <tr class="odd">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                 <!-- item-->
                                                <a href="view_photos.php?id=<?php echo $row['id'];?>" class="dropdown-item"><i class="mdi mdi-plus-circle me-2 text-muted font-18 vertical-middle"></i></i>Add</a>
                                                <!-- item-->
