                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Other Data</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Other Data</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
 ...
 <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM  tbl_other_data");
                      $cnt=1;
                      $stmt->execute();
                      foreach($stmt as $row){
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <a href="edit-content.php?id=<?php echo $row['id'];?>" class="dropdown-item"><i class="mdi mdi-pencil me-2 text-muted font-18 vertical-middle"></i></i>Edit</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
