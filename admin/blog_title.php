...
<?php
	if(isset($_POST['add'])){
		...
		$blog_title_name = $_POST['blog_title_name'];
		$blog_title_desc = $_POST['blog_title_desc'];
		...
		//	$password = password_hash($password, PASSWORD_DEFAULT);
			...
			try{
			 $stmt = $conn->prepare("INSERT INTO blog_titles (blog_title_name, blog_title_desc,blog_id) VALUES (:blog_title_name, :blog_title_desc, :blog_id)");
				$stmt->execute(['blog_title_name'=>$blog_title_name, 'blog_title_desc'=>$blog_title_desc, 'blog_id'=>$blog_id]);
...
<?php
	if(isset($_POST['delete'])){
		...
		try{
			$stmt = $conn->prepare("DELETE FROM blog_titles WHERE blog_title_id=:id");
			$stmt->execute(['id'=>$id]);

			$_SESSION['success'] = 'Title has deleted successfully';
		}
		catch(PDOException $e){
			$_SESSION['error'] = $e->getMessage();
		}
		...
		$_SESSION['error'] = 'Select Title to delete first';
	}
                ...
                ?>   
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="text-uppercase bg-light p-2 mt-0 mb-3">Blog Title List</h5>
                                ...
                                ?>
                                        <tr class="col-md-12">
                                           ...
                                           <?php echo $row2['blog_title_name'];?>
                                            </td>
                                             <td class="col-md-6" id="hidding_normal">
                                            <?php echo $row2['blog_title_desc'];?>
                                            </td>
                                            <td class="col-md-6" id="hidding_normal">
                                          <a class='delete' data-bs-toggle="modal" data-id="<?php echo $row2['blog_title_id'];?>" href="#delete"><i class='fa fa-trash' style='color:red'></i></a>
                                            </td>
                                    </tr> 
                                     <?php } ?>
                                </table>
                    ...
                    <div class="col-lg-6" >
                        <div class="card">
                            <div class="card-body">
                                <h5 class="text-uppercase mt-0 mb-3 bg-light p-2">Create Title</h5>
                                  <form  method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                         <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Name" name="blog_title_name">
                                            </div>
                                      
                                         <h5 class="text-uppercase bg-light p-2 mt-0 mb-3">Description</h5>
                                        <div class="mb-3">
                                            <textarea class="form-control ckeditor" name="blog_title_desc" rows="10" placeholder="Please enter Description" id="txtEditor"></textarea>
...
function getRow(id){
  $.ajax({
    type: 'POST',
    url: 'blog_title_row.php',
    data: {id:id},
    dataType: 'json',
    success: function(response){
     
      $('.distid').val(response.blog_title_id);
    }
  });
}
