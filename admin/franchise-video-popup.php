<!-- All User Modal edit  -->
    <div class="offcanvas offcanvas-end" tabindex="-1" id="edit_image" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel">Edit Photo</h5>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
             <form class="needs-validation" method="POST" action="category-photo.php" enctype="multipart/form-data" novalidate>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="activate" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
         ...
         <div class="offcanvas-body">
             <form class="needs-validation" method="POST" action="franchise-video-status.php" enctype="multipart/form-data" novalidate>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="add-banner1" aria-labelledby="offcanvasExampleLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasRightLabel">Add video</h5>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
            <form class="needs-validation" method="POST" action="add-franchise-videos.php" enctype="multipart/form-data" novalidate>
                <div class="mb-3">
                    <label for="banner" class="form-label">Video Url</label>
                     <input type="url" name="video_url" placeholder="video url" class="form-control" required>
                    <div class="invalid-feedback">
                        Please Enter url.
                    </div>
                </div>   
            ...
            <div class="modal-content modal-filled bg-danger">
                <div class="modal-body p-4">
                    <div class="text-center">
                        ...
                        <form method="POST" action="franchise-video-delete.php">
                             <input type="hidden" class="catid" name="id">
