...
<div class="offcanvas offcanvas-end" tabindex="-1" id="add-banner" aria-labelledby="offcanvasExampleLabel">
                    ...
                    <form class="needs-validation" method="POST" action="video_add.php" enctype="multipart/form-data" novalidate>
                    <div class="mb-3">
                     <label for="image" class="form-label">Upload Image</label>
                      <input type="url" class="form-control" name="video_url" placeholder="Enter Youtube Url" required>
                      <div class="invalid-feedback">
                        Please Enter Youtube Ur
                    </div>
                    </div>
                            <div class="mb-3">
                                <label for="name" class="form-label">Add Description </label>
                                <input type="text" class="form-control" name="name" placeholder="Enter Description" required>
                            </div>
                            <div class="text-end">
