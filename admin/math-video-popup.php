<!-- All User Modal edit  -->
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="activate" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header">
         ...
         <div class="offcanvas-body">
             <form class="needs-validation" method="POST" action="math-video-status.php" enctype="multipart/form-data" novalidate>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="add-banner1" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body">
            <form class="needs-validation" method="POST" action="add-math-videos.php" enctype="multipart/form-data" novalidate>
                <div class="mb-3">
            ...
            <div class="modal-content modal-filled bg-danger">
                <div class="modal-body p-4">
                    <div class="text-center">
                        ...
                        <form method="POST" action="math-video-delete.php">
                             <input type="hidden" class="catid" name="id">
