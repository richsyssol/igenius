                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Our Valuable Client</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Our Valuable Client</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="dt-buttons btn-group flex-wrap">
                                         <a href="#add-banner" class="btn btn-danger buttons-html5" data-bs-toggle="offcanvas"><i class="mdi mdi-plus-circle me-2"></i>Add Valuable Client</a>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style="width: 1244px;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 146.4px;" aria-label="Name: activate to sort column ascending">Area</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 146.4px;" aria-label="Name: activate to sort column ascending">Medium</th>
                                        ...
                                        <?php
                                            ...
                                            try{
                                              $stmt = $conn->prepare("SELECT * FROM tbl_clients Order By creation_on DESC");
                                              $cnt=1;
                                              $stmt->execute();
                                              foreach($stmt as $row){
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td> <?php echo mb_strimwidth($row['name'], 0, 50, "..."); ?></td>
                                            <td> <?php echo mb_strimwidth($row['area'], 0, 50, "..."); ?></td>
                                            <td> <?php echo mb_strimwidth($row['medium'], 0, 50, "..."); ?></td>
                                            <td><span class="badge badge-soft-success"> <?php echo mb_strimwidth($row['status'], 0, 50, "..."); ?></span></td>
