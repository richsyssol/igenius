                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">De-active-users</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">De-active Users</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
  ...
  <div class="row">
            <div class="col-12">
                <div class="card">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style="width: 1244px;">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 146.4px;" aria-label="Name: activate to sort column ascending">Name</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 73.4px;" aria-label="contact: activate to sort column ascending">Contact No</th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 139.4px;" aria-label="Email: activate to sort column ascending">Email</th>
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM users WHERE status='Deactive' and type=:type Order By created_on DESC");
                      $cnt=1;
                      $stmt->execute(['type'=>0]);
                      foreach($stmt as $row){
                        $image = (!empty($row['photo'])) ? 'assets/images/users/'.$row['photo'] : 'assets/images/users/profile.jpg';
                       
                        ?>
                                                 <tr class="odd">
                                                    <td class="dtr-control sorting_1" tabindex="0"><?php echo htmlentities($cnt++);?></td>
                                                    <td><img src="<?php echo $image;?>" alt="profile-pic" class="me-2" width="30"> </td>
                                    ...
                                    <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <!-- item-->
                                                <a href="javascript:void(0);" class="dropdown-item edit" data-bs-toggle="offcanvas" data-bs-target="#edit-duser" data-id="<?php echo $row['id'];?>"> <i class="mdi mdi-square-edit-outline me-2 text-muted font-18 vertical-middle"></i>Edit</a>
                                               
                                                <!-- item-->
                                                <a href="#edit_photo"data-bs-toggle="offcanvas" data-bs-target="#dedit_photo" data-id="<?php echo $row['id'];?>" class="dropdown-item photo"><i class="mdi mdi-image me-2 text-muted font-18 vertical-middle"></i></i>Change Profile</a>
...
<?php include 'deactive-user-popup.php'?>
