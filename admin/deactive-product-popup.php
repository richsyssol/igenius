<!-- Status -->
             <div class="offcanvas offcanvas-end" tabindex="-1" id="activate" aria-labelledby="offcanvasRightLabel">
                     ...
                     <div class="offcanvas-body">
                         <form class="needs-validation" method="POST" action="deactive-product-status.php" enctype="multipart/form-data" novalidate>
                         <input type="hidden" class="prodid mb-3" name="id">
                                                ...
                                                <div class="modal-content modal-filled bg-danger">
                                                    <div class="modal-body p-4">
                                                        <div class="text-center">
                                                            ...
                                                            <input type="text" class="prodid" name="id">
