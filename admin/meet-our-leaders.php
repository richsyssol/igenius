...
<?php include 'left-menu.php'?>
 ...
 <th class="sorting" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 146.4px;" aria-label="Name: activate to sort column ascending">Designation</th>
                                        ...
                                        <?php
                                            ...
                                            try{
                                              $stmt = $conn->prepare("SELECT * FROM tbl_leaders Order By creation_on DESC");
                                              $cnt=1;
                                              $stmt->execute();
                                              foreach($stmt as $row){
                                                $image = (!empty($row['image'])) ? 'assets/images/leaders/'.$row['image'] : 'assets/images/users/profile.jpg';
