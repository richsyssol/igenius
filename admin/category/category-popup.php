  <!-- All User Modal edit  -->
    <div class="offcanvas offcanvas-end" tabindex="-1" id="edit_image" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="addnew" aria-labelledby="offcanvasExampleLabel">
            ...
            <div class="offcanvas-body">
                <form class="needs-validation" method="POST" action="category_add.php" enctype="multipart/form-data" novalidate>
                    <div class="mb-3">
 ...
 <!-- Status -->
    <div class="offcanvas offcanvas-end" tabindex="-1" id="activate" aria-labelledby="offcanvasRightLabel">
        ...
        <div class="offcanvas-body">
            <form class="needs-validation" method="POST" action="category-status.php" enctype="multipart/form-data" novalidate>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="edit" aria-labelledby="offcanvasRightLabel">
                ...
                <div class="offcanvas-body">
                <form class="needs-validation" method="POST" action="category_edit.php" enctype="multipart/form-data" novalidate>
                    <input type="hidden" class="cid" name="id">
                    <div class="mb-3">
                        <label for="name" class="form-label"> Category Title </label>
                        <input type="text" class="form-control" placeholder="Enter Category" id="edit_category" name="name" required>
                        <div class="invalid-feedback">
                            Please Enter Category.
                        </div>
                    </div>
