...
<form class="needs-validation" method="POST" action="leaders_add.php" enctype="multipart/form-data" novalidate>
<div class="mb-3">
 ...
 <input type="file" id="image" name="image"  accept=" .jpg , .jpeg , .png " class="form-control" required>
  <div class="invalid-feedback">
    Please Select Photo.
        ...
        <div class="mb-3">
            <label for="name" class="form-label">Add Designation </label>
         ...
         <!-- Danger Alert Modal Delete add-user -->
                                        <div id="delete-banner" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog modal-sm">
                                                ...
                                                <form  method="POST" action="leaders_delete.php">
