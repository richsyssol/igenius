 ...
 <!-- active User Modal add  -->
    <div class="offcanvas offcanvas-end" tabindex="-1" id="add-banner1" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body">
            <form class="needs-validation" method="POST" action="f_testimonial_add.php" enctype="multipart/form-data" novalidate>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="image" class="form-label">Division</label>
                    <input type="text" name="division" placeholder="Enter Division" class="form-control" required>
                    <div class="invalid-feedback">
   ...
   <div class="offcanvas offcanvas-end" tabindex="-1" id="activate" aria-labelledby="offcanvasRightLabel">
                     ...
                     <div class="offcanvas-body">
                         <form class="needs-validation" method="POST" action="franchise-testimonial-status.php" enctype="multipart/form-data" novalidate>
         ...
         <!-- Danger Alert Modal Delete add-user -->
                                        <div id="delete" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog modal-sm">
                                                ...
                                                <form  method="POST" action="f_testimonial_delete.php">
                                             <input type="hidden" class="catid" name="id">
