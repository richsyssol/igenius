...
<!-- layouts/default/auth-signin-signup-2.html  09:06:11 -->
<head>
        <meta charset="utf-8" />
                ...
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <footer class="footer footer-alt">
                            <p class="text-muted"> <script>document.write(new Date().getFullYear())</script> &copy; Your Own Cafe  
                                <!-- <a href="javascript: void(0);" class="text-muted">Coderthemes</a>  -->
                            </p>
                        </footer>
