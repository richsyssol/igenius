                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="dt-buttons btn-group flex-wrap">
                                         <a href="#add-banner" class="btn btn-danger buttons-html5" data-bs-toggle="offcanvas"><i class="mdi mdi-plus-circle me-2"></i>Add Video</a>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable-buttons_info" style="width: 1244px;">
                                        ...
                                        <?php
                                            ...
                                            try{
                                              $stmt = $conn->prepare("SELECT * FROM tbl_videos Order By creation_on DESC");
                                              $cnt=1;
                                              $stmt->execute();
                                              foreach($stmt as $row){
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td> <a href="<?php echo $row['video_url'];?>"><?php echo mb_strimwidth($row['video_url'], 0, 20, "..."); ?></a></td>
