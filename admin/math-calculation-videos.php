                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Math Calculation Videos</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Math Calculation Videos</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
...
<?php include 'math-video-popup.php'?>
