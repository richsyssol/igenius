                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">shining moments</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">shining moments</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
            ...
            <div class="col-12">
                <div class="card">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="dt-buttons btn-group flex-wrap">
                                         <a href="#add-banner1" class="btn btn-danger buttons-html5" data-bs-toggle="offcanvas"><i class="mdi mdi-plus-circle me-2"></i>Add Event</a>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-6">
                    ...
                    try{
                      ...
                      $stmt->execute();
                      foreach($stmt as $row){
                        $image = (!empty($row['image'])) ? 'assets/images/event/'.$row['image'] : 'assets/images/users/profile.jpg';
                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                       <a href="javascript:void(0);" data-bs-toggle="offcanvas" data-bs-target="#activate" data-id="<?php echo $row['id'];?>" class="dropdown-item status"><i class="mdi mdi-pencil me-2 text-muted font-18 vertical-middle"></i></i>Edit Moment</a>
                                        <a href="view_moment.php?id=<?php echo $row['id'];?>" class="dropdown-item"><i class="mdi mdi-image me-2 text-muted font-18 vertical-middle"></i></i>Add</a>
