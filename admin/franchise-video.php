                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Franchise Videos</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Franchise Videos</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
 ...
 <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM tbl_franchise_video");
                      $cnt=1;
                      $stmt->execute();
                      foreach($stmt as $row){
...
<?php include 'franchise-video-popup.php'?>
