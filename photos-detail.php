    ...
    <div class="container text-center">
         <?php
            $id = $_GET['id'];
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM tbl_photos WHERE id='$id'");
                      $cnt=1;
                      $stmt->execute();
                      foreach($stmt as $row){
                        //$image = (!empty($row['image'])) ? 'admin/assets/images/photos/details/'.$row['image'] : 'assets/images/users/profile.jpg';
        ...
        <div class="row justify-content-center py-4">
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-4 anime1" data-aos="zoom-in" data-aos-duration="1000">
                <div class="card imgcard h-75">
                    <img class="card-img-top img-gallary" src="<?php echo $image;?>" alt="event-photos">
