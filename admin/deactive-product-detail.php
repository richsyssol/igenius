                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="deactive-product.php">Deactive product</a></li>
                                            
                                            <li class="breadcrumb-item active">Product Detail</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Deactive Product Detail</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <div class="ps-xl-3 mt-3 mt-xl-0">
                                                    ...
                                                    <div>
                                                        <button type="button" class="btn btn-danger me-2"><i class="mdi mdi-heart-outline"></i></button>
