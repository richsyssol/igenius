                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">Franchise Testimonials List</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">Franchise Testimonials List</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
 ...
 <div class="row">
            <div class="col-12">
                <div class="card">
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 199.4px;" aria-sort="ascending" aria-label="srno: activate to sort column descending">Sr No</th>
                                                     ...
                                                     <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 199.4px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">Name</th>
                                                     <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 199.4px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">Division</th>
                                                     <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable-buttons" rowspan="1" colspan="1" style="width: 199.4px;" aria-sort="ascending" aria-label="Description: activate to sort column descending">Description</th>
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM franchise_testimonial");
                      $cnt=1;
                      $stmt->execute();
                      foreach($stmt as $row){
                      //  $image = (!empty($row['photo'])) ? 'assets/images/side_banner/'.$row['photo'] : 'assets/images/users/profile.jpg';
                        ...
                        <tr class="odd">
                            ...
                            <td><a href="assets/images/franchise/<?php echo $row['image'];?>" target="_blank"><img src="assets/images/franchise/<?php echo $row['image'];?>" width="30"></a></td>
                            <td><?php echo $row['name'];?></td>
                            <td><?php echo $row['division'];?></td>
                            <td value="<?php echo $row['description'];?>"><?php echo mb_strimwidth($row['description'], 0, 50, "..."); ?></td>
...
<?php include 'franchise-testimonials-popup.php'?>
