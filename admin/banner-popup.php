   ...
   <div class="offcanvas offcanvas-end" tabindex="-1" id="edit_image" aria-labelledby="offcanvasRightLabel">
    ...
    <!-- Status -->
             <div class="offcanvas offcanvas-end" tabindex="-1" id="activate" aria-labelledby="offcanvasRightLabel">
                     ...
                     <div class="offcanvas-body">
                         <form class="needs-validation" method="POST" action="banner-status.php" enctype="multipart/form-data" novalidate>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="add-banner" aria-labelledby="offcanvasExampleLabel">
                                         <div class="offcanvas-header">
                                                    <h5 id="offcanvasRightLabel">Add  Banner</h5>
                                                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                                </div>
                     <div class="offcanvas-body">
                    <form class="needs-validation" method="POST" action="banner_add.php" enctype="multipart/form-data" novalidate>
                    <div class="mb-3">
                     <label for="image" class="form-label">Upload Banner</label>
                     <input type="file" id="image" name="image"  accept=" .jpg , .jpeg , .png, .mp4, .mov, .gif, .svg " class="form-control" required>
                      <div class="invalid-feedback">
                        Please Select Photo.
                    </div>
                    </div>
                           ...
                           <div class="mb-3">
                             ...
                             <div class="mb-3">
                                <label for="position" class="form-label"  >Media Type</label>
         ...
         <!-- Danger Alert Modal Delete add-user -->
                                        <div id="delete-banner" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog modal-sm">
                                                ...
                                                <form  method="POST" action="banner-delete.php">
                                             <input type="hidden" class="catid" name="id">
